        ...
        <div className=" mx-auto flex px-20 pt-20 lg:pt-0  md:flex-row flex-col items-center bg-slate-600">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <div className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              <p className="text-4xl lg:text-8xl text-sky-300">Before they sold </p>
              <p>readymade gluten</p>
            </div>
            <p className="mb-8 leading-relaxed text-white text-xl">Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic tumeric truffaut hexagon try-hard chambray.</p>
