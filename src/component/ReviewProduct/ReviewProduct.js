...
const ReviewProduct = ({ cart }) => {
    const {name, title, img, description, price} = cart;
    return (
        <div>
            


            <div className="md:max-w-sm bg-white rounded-lg shadow-lg h-full dark:bg-gray-800 dark:border-gray-700">
<a href="#">
...
<h6 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{title.length > 20 && title.slice(0, 25)}</h6>
</a>
...
<h6 className="text-md text-gray-500 pt-5 font-semibold tracking-tight text-gray-900 dark:text-white">{description.length > 20 && description.slice(0, 120) + '....'}</h6>
</div>
</div>
